...
public class AddDocumentTemplateUseCase
    : UseCaseBase,
    IAddDocumentTemplateUseCase
{
    #region Constructors
    public AddDocumentTemplateUseCase(IDocumentTemplateDomainService documentTemplateDomainService, IUnitOfWork unitOfWork)
    {
