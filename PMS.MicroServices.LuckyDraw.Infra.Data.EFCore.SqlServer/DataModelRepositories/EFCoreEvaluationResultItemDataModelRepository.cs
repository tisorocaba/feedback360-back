...
public class EFCoreEvaluationResultItemDataModelRepository
    : EFCoreDataModelRepositoryBase<EvaluationResultItemDataModel, Guid>,
    IEFCoreEvaluationResultItemDataModelRepository
{
    #region Constructors
    public EFCoreEvaluationResultItemDataModelRepository(IDbContext context)
        : base(context)
    {
        this.DbSet.Include(i => i.EvaluationResult);
        this.DbSet.Include(i => i.Question);
    }
