...
public class CoWorkerMongoDbDataModelMap
    : IMongoDbDataModelMap<CoWorkerMongoDbDataModel>
{
    #region Methods
    public void Map()
    {
        BsonClassMap.RegisterClassMap<CoWorkerMongoDbDataModel>(classMap =>
        {
            classMap.SetDiscriminator(InfraDataMongoDBConstants.CoWorkerCollectionName);
            ...
            classMap.MapMember(dataModel => dataModel.EvaluatedCoWorker).SetElementName(InfraDataMongoDBConstants.EvaluatedCoWorkerAttributeName);
            classMap.MapMember(dataModel => dataModel.CoWorkerType).SetElementName(InfraDataMongoDBConstants.CoWorkerTypeAttributeName);
            classMap.MapMember(dataModel => dataModel.CoWorkerTeam).SetElementName(InfraDataMongoDBConstants.CoWorkerTeamAttributeName);
